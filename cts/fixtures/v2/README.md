...
- 112 accept/reject proposal fixtures (44 accept, 68 reject) cover promoted inline image, AEON
...
- `../../contracts/v2-projection-v1.json` pins 36 exact standalone/embedded canonical snapshots,
  19 inert HTML snapshots, 31 exact source-span assertions, and a 21-entry cross-form interaction
